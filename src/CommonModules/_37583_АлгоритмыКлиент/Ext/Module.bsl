...
Процедура ВыполнитьКодАлгоритмаНаКлиенте(this,ПредставлениеАлгоритма,Параметры)
   ...
   СвойстваАлгоритма = Новый Структура("Ссылка,КодАлгоритма,КодЗавершения,ТолькоТекст,ВыбрасыватьИсключение,ЗаписыватьОшибкиВЖР,Отказ",Неопределено,"","",Ложь,Истина,Истина,Ложь);
